...
import com.alohatechnology.nsdemulator.databinding.ResponseTemplateBottomSheetFragmentBinding
...
class ResponseTemplateBottomSheetFragment : BottomSheetDialogFragment(), ResponseTemplateAdapter.ResponseTemplateClickListener {
    ...
    private var binding: ResponseTemplateBottomSheetFragmentBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.response_template_bottom_sheet_fragment, container, false)
        return binding?.root
    }
